...
Loader::Loader(TextureManager* texture,SoundManager* sound)
{
	...
	AddModel(ModelIndex::BORAD_ABUTTON, "board");
	//パーティクル用モデル読み込み
	...
	textureManager->LoadTexture(9, L"Resources/AbuttonBorad.png");
...
void Loader::Initialize(DirectXCommon* dxCommon, TextureManager* textureManager)
{
	...
	model[ModelIndex::BORAD_ABUTTON]->Initialize(dxCommon, textureManager, 9);
